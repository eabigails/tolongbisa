                    ...
                    <div class="relative card-body">
                        <div class="grid items-center grid-cols-12">
                            <div class="col-span-12 lg:col-span-8 2xl:col-span-7">
                                <h5 class="mb-3 font-normal tracking-wide text-slate-200">Welcome Queen of Thrift 🎉</h5>
                        ...
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-slate-500 dark:text-zink-200">arthur@qot.com</p>
                                </div>
                                <div class="shrink-0">
                                    <h6>$2,452</h6>
                                </div>
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-slate-500 dark:text-zink-200">natalie@qot.com</p>
                                </div>
                                <div class="shrink-0">
                                    <h6>$1,893</h6>
                                </div>
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-slate-500 dark:text-zink-200">jackson@qot.com</p>
                                </div>
                                <div class="shrink-0">
                                    <h6>$1,196</h6>
                                </div>
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-slate-500 dark:text-zink-200">torres@qot.com</p>
                                </div>
                                <div class="shrink-0">
                                    <h6>$976</h6>
                                </div>
