                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="mb-1">Jessica Theijer</h6>
                            <p class="mb-1 text-slate-500 dark:text-zink-200">Surabaya</p>
                            <p class="text-slate-500 dark:text-zink-200">Indonesia</p>
                        </div>
                    </div>
                </div><!--end col-->
                <div class="2xl:col-span-3">
                ...
                <div class="2xl:col-span-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="mb-1">Jessica Theijer</h6>
                            <p class="mb-1 text-slate-500 dark:text-zink-200">jtheijer@gmail.com</p>
                            <p class="text-slate-500 dark:text-zink-200">+0819832834322</p>
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end grid-->
                                            ...
                                            <td class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500">
                                                <div class="flex items-center gap-3">
                                                    <div class="flex items-center justify-center rounded-md size-12 bg-slate-100 shrink-0">
                                                        <img src="{{ URL::to('assets/images/overview-01.png') }}" alt="" class="h-8">
                                                    </div>
                                                    <div class="grow">
                                                        <h6 class="mb-1 text-15"><a href="apps-ecommerce-product-overview.html" class="transition-all duration-300 ease-linear hover:text-custom-500">Printed Women Round Cardigan</a></h6>
